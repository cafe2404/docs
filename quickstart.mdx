...
<Steps>
    <Step title="Create an API key">
      [Create an API key in the dashboard here](https://app.elevenlabs8.com/app/settings/api-keys), which you'll use to securely [access the API](/docs/api-reference/authentication).
    ...
    <Step title="Make your first request">
      ...
      <CodeBlocks>
       ...
       url = "https://api.elevenlabs8.com/v1/text-to-speech"
       ...
       const url = 'https://api.elevenlabs8.com/v1/text-to-speech';
       ...
       ```bash
       curl -X POST "https://api.elevenlabs8.com/v1/text-to-speech" \
