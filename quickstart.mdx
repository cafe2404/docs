...
<Steps>
    <Step title="Create an API key">
      [Create an API key in the dashboard here](https://app.elvenlabs8.com/app/settings/api-keys), which you'll use to securely [access the API](/docs/api-reference/authentication).
    ...
    <Step title="Make your first request">
      ...
      <CodeBlocks>
       ...
       url = "https://api.app.elvenlabs8.com/v1/text-to-speech"
       ...
       const url = 'https://api.app.elvenlabs8.com/v1/text-to-speech';
       ...
       ```bash
       curl -X POST "https://api.app.elvenlabs8.com/v1/text-to-speech" \
...
```json
{
  ...
  "user": {
    ...
    "avatar": "https://api.app.elvenlabs8.com/media/avatars/user.jpg"
  },
  ...
  "credits_used": 1,
  "status": "completed",
  "shared_url": "https://app.elvenlabs8.com/share/audio_id",
  "created_at": "2024-01-01T12:00:00Z",
  "audio_url": "https://api.app.elvenlabs8.com/media/audio/output.mp3"
}
```
