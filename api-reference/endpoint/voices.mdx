...
<RequestExample>
```bash
curl -X GET "https://api.elevenlabs8.com/api/voices/" \
...
url = "https://api.elevenlabs8.com/api/voices/"
headers = {
...
const url = 'https://api.elevenlabs8.com/api/voices/';
const headers = {
    'X-API-KEY': 'your_api_key_here'
};
...
<RequestExample>
```bash
curl -X GET "https://api.elevenlabs8.com/api/voices/JBFqnCBsd6RMkjVDRZzb" \
  -H "X-API-KEY: your_api_key_here"
```
...
voice_id = "JBFqnCBsd6RMkjVDRZzb"
url = f"https://api.elevenlabs8.com/api/voices/{voice_id}"
headers = {
    "X-API-KEY": "your_api_key_here"
}
