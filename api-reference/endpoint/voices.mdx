...
<RequestExample>
```bash
curl -X GET "https://api.app.elvenlabs8.com/api/voices/" \
...
url = "https://api.app.elvenlabs8.com/api/voices/"
headers = {
...
const url = 'https://api.app.elvenlabs8.com/api/voices/';
const headers = {
    'X-API-KEY': 'your_api_key_here'
};
  ...
  "voices": [
    {
      ...
      "preview_url": "https://api.app.elvenlabs8.com/media/samples/rachel.mp3",
      ...
      "sharing": {
        ...
        "image_url": "https://api.app.elvenlabs8.com/media/avatars/rachel.jpg",
        "ban_reason": null,
        "liked_by_count": 0,
        "cloned_by_count": 0,
        "name": "Rachel",
      ...
      "verified_languages": [
        {
          ...
          "accent": "american",
          "locale": "en-US",
          "preview_url": "https://api.app.elvenlabs8.com/media/samples/rachel_en.mp3"
        }
      ],
      "safety_control": "NONE",
      "voice_verification": {
...
<RequestExample>
```bash
curl -X GET "https://api.app.elvenlabs8.com/api/voices/JBFqnCBsd6RMkjVDRZzb" \
  -H "X-API-KEY: your_api_key_here"
```
...
voice_id = "JBFqnCBsd6RMkjVDRZzb"
url = f"https://api.app.elvenlabs8.com/api/voices/{voice_id}"
headers = {
    "X-API-KEY": "your_api_key_here"
}
